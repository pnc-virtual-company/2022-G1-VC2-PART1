    ...
    <div class="card">
      ...
      <div class="card-list" v-for:="(student, index) of listOfStudents">
        <div class="user">
          ...
          <div class="info">
            <span
              ><strong>{{ student.username }}</strong></span
            >
          </div>
        </div>
        <div class="icon">
          <button @click="UpdateStudent(student)" class="btnedit">
            <img src="../../assets/edit.png" alt="" />
          </button>
          <button @click="removeStudent(index, student.id)" class="btnDelete">
