          ...
          <div class="card" @click="getAleave(leave.id)">
            <div class="student">
              <div
                ...
                :style="{ 'border-left': '3px solid #FF9620' }"
              >
                <img
                  :src="
...
export default {
  ...
  methods: {
    ...
    updateReject(leave) {
      axios
        .put("student_leave_request/" + leave.id, { status: "Reject" })
        .then((res) => {
    ...
    updateAproved(leave) {
      axios
        .put("student_leave_request/" + leave.id, { status: "Aproved" })
        .then((res) => {
          this.getAleave(leave.id);
          this.getlistOfStudentsLeave();
          console.log(res.data);
